    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-card-dark text-sm text-text-muted">
            No image
          </div>
        )}
      </div>
      ...
      {item.tag && (
        <div className="absolute top-3 left-3 z-10">
          <span className="bg-primary/90 text-black text-[10px] font-bold px-2.5 py-1 rounded-full">
            {item.tag}
          </span>
        </div>
      )}

...
export function DashboardNav({ links, isAdmin = false, isMimicking = false }: { links: NavLink[]; isAdmin?: boolean; isMimicking?: boolean }) {
      ...
      {isAdmin && (
        <div className="mt-3 pt-3 border-t border-border">
          ...
          >
            ...
            {isMimicking ? "Back to Admin" : "Admin Panel"}
          </Link>
        </div>
      )}
    </nav>

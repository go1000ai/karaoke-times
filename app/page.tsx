    ...
    <div ref={scrollRef} className="min-h-screen bg-bg-dark overflow-x-hidden">
      ...
      <footer className="py-12 pb-28 md:pb-12">
        <div className="max-w-2xl mx-auto px-6">
          <div className="glass-card rounded-full px-4 py-4 flex items-center">
            {/* Logo */}
            ...
            {/* Terms */}
            <div className="flex-1 flex justify-center">
              <Link href="/terms" className="text-text-muted text-[10px] hover:text-primary transition-colors">
                Terms
              </Link>
            </div>
            ...
            {/* Privacy */}
            <div className="flex-1 flex justify-center">
              <Link href="/privacy" className="text-text-muted text-[10px] hover:text-primary transition-colors">
                Privacy
              </Link>
            </div>
            ...
            {/* Contact */}
            <div className="flex-1 flex justify-center">
              <a href="mailto:info@go1000.ai" className="text-text-muted text-[10px] hover:text-primary transition-colors">
                Contact
              </a>
            </div>
          </div>

  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-bg-dark">
      ...
      <div className="relative z-10 flex flex-col items-center px-6 w-full max-w-md mx-auto py-12">
        ...
        <Link
          href="/"
          className="w-full glass-card text-white font-semibold py-4 rounded-2xl flex items-center justify-center gap-3 mb-3 hover:border-primary/30 transition-all"
        >
        ...
        <Link
          href="/"
          className="w-full bg-white text-black font-semibold py-4 rounded-2xl flex items-center justify-center gap-3 mb-6 hover:bg-gray-100 transition-colors"
        >
        ...
        <Link
          href="/"
          className="text-primary text-sm font-semibold flex items-center gap-2 hover:underline neon-glow-green"
        >

      ...
      <div className="min-h-screen pb-28 md:pb-12 bg-bg-dark">
        <div className="max-w-md mx-auto pt-24 px-5 text-center">
          ...
          <p className="text-sm text-text-secondary mb-6">
            Get email reminders for your favorite karaoke nights.
          </p>
          <Link
            href="/signin"
      ...
      <div className="max-w-lg mx-auto pt-20 px-5">
        ...
        <div className="glass-card rounded-2xl p-4 mb-6 flex items-start gap-3">
          ...
          <p className="text-xs text-text-secondary leading-relaxed">
            Set up reminders on any venue page by tapping <strong className="text-white">Remind Me</strong>.
            You can add calendar events or get email reminders for your favorite karaoke nights.
          </p>
        </div>
        ...
        {loading ? (
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 mt-1.5">
                      <span className="material-icons-round text-xs text-accent">
                        email
                      </span>
          ...
          <div className="glass-card rounded-2xl p-10 text-center">
            ...
            <p className="text-sm text-text-secondary mb-5">
              Browse venues and set reminders for karaoke nights you don&apos;t
              want to miss!
            </p>
            <Link
              href="/"
